...
export function decrypt (word, key = baseKey, iv = baseIv) {
  ...
  let decrypt = cryptoJs.AES.decrypt(srcs, keyObj, { iv: ivObj, mode: cryptoJs.mode.CBC, padding: cryptoJs.pad.Pkcs7 })
...
export function encrypt (word, key = baseKey, iv = baseIv) {
  ...
  let encrypted = cryptoJs.AES.encrypt(srcs, keyObj, { iv: ivObj, mode: cryptoJs.mode.CBC, padding: cryptoJs.pad.Pkcs7 })
